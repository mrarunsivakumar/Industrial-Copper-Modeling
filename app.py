...
if selected == "Predicting Selling Price":
        ...
        if submit_button and flag==0:
            ...
            with open(r"C:\\Users\\mraru\\Downloads\\model.pkl", 'rb') as file:
                loaded_model = pickle.load(file)
            with open(r'C:\\Users\\mraru\\Downloads\\scaler.pkl', 'rb') as f:
                scaler_loaded = pickle.load(f)

            with open(r"C:\\Users\\mraru\\Downloads\\t.pkl", 'rb') as f:
                t_loaded = pickle.load(f)

            with open(r"C:\\Users\\mraru\\Downloads\\s.pkl", 'rb') as f:
    ...
    # Define the possible values for the dropdown menus
        ...
        with st.form("my_form1"):
            ...
            if csubmit_button and cflag==0:      
                 with open(r"C:\\Users\\mraru\\Downloads\\cmodel.pkl", 'rb') as file:
                     cloaded_model = pickle.load(file)

                 with open(r'C:\\Users\\mraru\\Downloads\\cscaler.pkl', 'rb') as f:
                     cscaler_loaded = pickle.load(f)
 
                 with open(r"C:\\Users\\mraru\\Downloads\\ct.pkl", 'rb') as f:
